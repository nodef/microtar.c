# microtar
A lightweight tar library written in ANSI C, by [rxi](https://github.com/rxi).
...
And then include `microtar.h` as follows:
```c
#include "node_modules/microtar.c/src/microtar.h"
```

You may also want to include `microtar.c` as follows:
```c
#ifndef __MICROTAR_C__
#define __MICROTAR_C__
#include "node_modules/microtar.c/src/microtar.c"
#endif
```
...
included in an existing project and compiled along with it.
...
![](https://ga-beacon.deno.dev/G-RC63DPBH3P:SH3Eq-NoQ9mwgYeHWxu7cw/github.com/nodef/microtar.c)
[![SRC](https://img.shields.io/badge/src-repo-green?logo=Org)](https://github.com/rxi/microtar)
